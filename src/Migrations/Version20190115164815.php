 ...
 */
final class Version20190115164815 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD description LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
